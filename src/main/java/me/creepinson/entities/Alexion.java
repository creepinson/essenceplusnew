...
public class Alexion {
	...
	public void registerRenderers() {
		RenderLiving customRender = new RenderLiving(Minecraft.getMinecraft().getRenderManager(),
				new Alexion.ModelAlexion(), 0) {
			protected ResourceLocation getEntityTexture(Entity par1Entity) {
				return new ResourceLocation(RefStrings.MODID + ":" + "textures/entity/alexion-texturemap.png");
			}
		};
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class,
				new RenderSnowball(Minecraft.getMinecraft().getRenderManager(), new ItemStack(Items.STICK).getItem(),
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		EntityRegistry.registerModEntity(new ResourceLocation("meepersplus:entitybulletalexion"),
				EntityArrowCustom.class, "entitybulletalexion", entityID2, instance, 64, 1, true);
	...
	public static class Entityalexion extends EntityMob implements IRangedAttackMob {
		...
		public void onLivingUpdate() {
			...
			if (true)
				for (int l = 0; l < 9; ++l) {
					...
					par1World.spawnParticle(EnumParticleTypes.PORTAL, par2, par3, par4, 0.0D, 0.0D, 0.0D);
				}
		}
		...
		protected net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation("meepersplus:alexion.ambient"));
		}

		@Override
		protected net.minecraft.util.SoundEvent getHurtSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation("meepersplus:alexion.hurt"));
		}

		@Override
		protected net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation("meepersplus:alexion.death"));
		}
