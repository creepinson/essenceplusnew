...
public class Craeol {
	...
	public void registerRenderers(){
		RenderLiving customRender = new RenderLiving(Minecraft.getMinecraft().getRenderManager(), new Craeol.ModelCraeol(), 0){protected ResourceLocation getEntityTexture(Entity par1Entity){return new ResourceLocation(RefStrings.MODID + ":" + "textures/entity/craeol-texturemap.png");}};
		RenderingRegistry.registerEntityRenderingHandler(Craeol.Entitycraeol.class, customRender);
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, new RenderSnowball(Minecraft.getMinecraft().getRenderManager(), new ItemStack(Items.CHICKEN).getItem() ,Minecraft.getMinecraft().getRenderItem()));
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		mobid = entityID;
		EntityRegistry.registerModEntity(new ResourceLocation("meepersplus:craeol"), Craeol.Entitycraeol.class, "craeol", entityID, instance, 64, 1, true, (255 << 16) + (0 << 8) + 0, (204 << 16) + (204 << 8) + 204);
		EntityRegistry.addSpawn(Craeol.Entitycraeol.class, 19, 3, 30, EnumCreatureType.MONSTER , Biome.REGISTRY.getObject(new ResourceLocation("desert")));

        
		
		int entityID2 = MathHelper.getRandomUUID().hashCode();
EntityRegistry.registerModEntity(new ResourceLocation("meepersplus:entitybulletcraeol"), EntityArrowCustom.class, "entitybulletcraeol", entityID2, instance, 64, 1, true);
...
this.world.spawnEntity(entityarrow);
	    ...
	    {
	        return (net.minecraft.util.SoundEvent)net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("meepersplus:craeol.ambient"));
	    }

	    @Override
	    protected net.minecraft.util.SoundEvent getHurtSound()
	    {
	        return (net.minecraft.util.SoundEvent)net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("meepersplus:craeol.hurt"));
	    }
		
		@Override
	    protected net.minecraft.util.SoundEvent getDeathSound()
	    {
			return (net.minecraft.util.SoundEvent)net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("meepersplus:craeol.death"));
	    }
