...
public class Neote {
	...
	public void registerRenderers(){
		RenderLiving customRender = new RenderLiving(Minecraft.getMinecraft().getRenderManager(), new Neote.ModelNeote(), 0){protected ResourceLocation getEntityTexture(Entity par1Entity){return new ResourceLocation(RefStrings.MODID + ":" + "textures/entity/neote-texturemap.png");}};
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		mobid = entityID;
		EntityRegistry.registerModEntity(new ResourceLocation("meepersplus:neote"), Neote.Entityneote.class, "neote", entityID, instance, 64, 1, true, (0 << 16) + (0 << 8) + 153, (204 << 16) + (0 << 8) + 102);
		EntityRegistry.addSpawn(Neote.Entityneote.class, 20, 3, 30, EnumCreatureType.CREATURE , clean(Biome.REGISTRY));
...
if(this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE)!=null)this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(1D);
}
...
this.dropItem(new ItemStack(Items.GOLD_INGOT).getItem(), 1);
	    ...
	    {
			return (net.minecraft.util.SoundEvent)net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("meepersplus:neote.ambient"));
	    }

	    @Override
	    protected net.minecraft.util.SoundEvent getHurtSound()
	    {
			return (net.minecraft.util.SoundEvent)net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("meepersplus:neote.hurt"));
	    }
		
		@Override
	    protected net.minecraft.util.SoundEvent getDeathSound()
	    {
			return (net.minecraft.util.SoundEvent)net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("meepersplus:neote.death"));
	    }
