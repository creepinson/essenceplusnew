...
public class RenderCreepino extends RenderLiving<EntityCreepino>{
		...
		private final ResourceLocation creepinoWhite = new ResourceLocation(RefStrings.MODID, "textures/entity/creepino/creepino_white.png");

	    private final ResourceLocation creepinoRed = new ResourceLocation(RefStrings.MODID, "textures/entity/creepino/creepino_red.png");
