...
public class Pedastal_Magic extends ModBlocks implements ITileEntityProvider {
    ...
    public Pedastal_Magic(Material mat, String name, CreativeTabs tab, float hardness, float resistance, int harvest,
                          String tool) {
    ...
    public void harvestBlock(World world, EntityPlayer player, BlockPos pos, IBlockState state, TileEntity te,
        ...
        if (!world.isRemote) {
            ...
            if (te instanceof TileEntityPedastal_Magic) {
                ...
                EntityItem itemDropped = new EntityItem(world, pos.getX(), pos.getY() + 1, pos.getZ(), teCv.getStack());

                world.spawnEntity(itemDropped);

                teCv.setStack(ItemStack.EMPTY);
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
        ...
        if (!world.isRemote) {
            TileEntityPedastal_Magic te = null;
            if (world.getTileEntity(pos) instanceof TileEntityPedastal_Magic) {
               te = (TileEntityPedastal_Magic) world.getTileEntity(pos);
            }
            else {
                return false;
            }
...
//
            ...
            } else if (!te.getStack().isEmpty() && player.getHeldItem(hand).isEmpty()) {
