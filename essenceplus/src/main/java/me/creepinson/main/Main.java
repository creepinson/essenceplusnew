...
import me.creepinson.entities.Loukatorin;
...
@net.minecraftforge.fml.common.Mod(modid = me.creepinson.lib.RefStrings.MODID, version =  me.creepinson.lib.RefStrings.VERSION, dependencies = "required-after:cjcore")
...
Loukatorin loukatorin = new Loukatorin();
...
public int getBurnTime(ItemStack fuel) {
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
    	...
    	neote.preInit(event);
    	loukatorin.instance = this.instance;
    	loukatorin.preInit(event);
    	//SOUNDS
