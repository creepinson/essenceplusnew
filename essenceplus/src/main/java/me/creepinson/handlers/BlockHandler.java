...
public class BlockHandler {
	...
	public static void init() {
		...
		BlockMobChamberCore = new me.creepinson.blocks.BlockMagicalCore(Material.ROCK, "MobChamberCore",
				CreativeTabHandler.ESSENCEPLUS_BASE, 5F, 15F, 3, "pickaxe");

		MobChamberCore = (ItemBlock) new ItemBlock(BlockMobChamberCore);

		BlockPedastal_Magic = new me.creepinson.blocks.pedestal.Pedastal_Magic(Material.ROCK, "pedastal_magic",
				CreativeTabHandler.ESSENCEPLUS_BASE, 5F, 15F, 3, "pedastal_magic");
	...
	public static void register() {
		...
		// GameRegistry.register(MobChamberCore,
		// BlockMobChamberCore.getRegistryName());
